...
const addLecture = () => {
  ...
  const handleSubmit = async (e) => {
    try{
      e.preventDefault()
      if (!image) {
  toast.error("Thumbnail Not Added");
  return;
}
  ...
  transition-all ${chapter.collapsed && "-rotate-90"}`}
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  ...
                  <div
                    className="inlin-flex bg-gray-100 p-2 rounded
            ...
            >
              ...
              >
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border border-gray-300 rounded py-1 px-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
